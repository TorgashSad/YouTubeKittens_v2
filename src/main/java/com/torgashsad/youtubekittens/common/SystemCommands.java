...
public enum SystemCommands implements Commands {
    HELP("/help") {
        ...
        public Optional<String> getResponse() {
            return Optional.of("Hello. This is start message. PRESS A BUTTON TO GET ANIMALS!!!");
        }
    },
    START("/start") {
        @Override
        public Optional<String> getResponse() {
            return Optional.of("This is a bot that sends you random videos with animals according to your preferences.\n" +
    ...
    public static Stream<SystemCommands> stream() {
